...
const AdminDashboard = () => {
    ...
    useEffect(() => {
        const fetchTopMovies = async () => {
            try {
                // TMDB API'den doğrudan top rated filmlerini çek
                ...
                console.log("Raw TMDB data:", data.results[0]);
                
                // API'den gelen verileri FavoriteMoviesDTO formatına dönüştür
                ...
                console.error("En çok favorilenen filmleri çekerken hata:", error);
            }
        };
                            ...
                            topMovies.map((movie) => (
                                <div key={movie.id} className="movie-list-item">
                                    <div className="movie-list-info">
                                        <img 
                                            src={movie.posterPath ? `https://image.tmdb.org/t/p/w500${movie.posterPath}` : '/placeholder-image.jpg'} 
                                            alt={movie.title}
                                            className="movie-list-poster"
                                            onError={(e) => {
                                                console.log("Image failed to load:", movie.posterPath);
                                    ...
                                    <div className="movie-list-favorites">
                                        <span>Rating: {movie.rating ? movie.rating.toFixed(1) : "N/A"}</span>
                                    </div>
                                </div>
                            ))
                        ) : (
