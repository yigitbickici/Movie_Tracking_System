...
public class AdminController {
    ...
    @GetMapping("/top-favorite-movies")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<List<FavoriteMoviesDTO>> getTopFavoriteMovies() {
        return ResponseEntity.ok(adminService.getTopFavoriteMovies());
    }
}
